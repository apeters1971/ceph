...
ErasureCodeIsaDefault::get_decoding_table_from_cache(std::string &signature, unsigned char* &table)
{
  ...
  dout(10) << "[ get table    ] = " << signature << dendl;
  ...
  if (g_decode_tbls_map.count(signature)) {
    dout(10) << "[ cached table ] = " << signature << dendl;
    ...
    dout(10) << "[ cache size   ] = " << g_decode_tbls_lru.size() << dendl;
...
ErasureCodeIsaDefault::put_decoding_table_to_cache(std::string &signature, unsigned char* &table)
{
  ...
  dout(10) << "[ put table    ] = " << signature << dendl;
  ...
  if (g_decode_tbls_lru.size() >= g_decode_tbls_lru_length) {
    dout(10) << "[ shrink lru   ] = " << signature << dendl;
    // reuse old buffer
    ...
    dout(10) << "[ store table  ] = " << signature << dendl;
                                  ...
                                  int blocksize)
{
  ...
  if (!get_decoding_table_from_cache(erasure_signature, p_tbls)) {
    ...
    // there are (k,m) combinations which cannot be 
