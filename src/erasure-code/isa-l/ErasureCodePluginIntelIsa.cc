...
/**
 * @file   ErasureCodePluginIntelIsa.cc
 *
...
{
  return *_dout << "ErasureCodePluginIntelIsa: ";
}

// -----------------------------------------------------------------------------
class ErasureCodePluginIntelIsa : public ErasureCodePlugin {
...
int __erasure_code_init(char *plugin_name)
{
  ...
  return instance.add(plugin_name, new ErasureCodePluginIntelIsa());
}
